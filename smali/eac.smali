...
.method public constructor <init>(Landroid/content/res/Resources;Lfdg;Livv;Ljava/util/concurrent/ScheduledExecutorService;[B[B[B[B)V
    ...
    const-string v3, "brella_imax_smarts_chip"
    ...
    iput-object v0, v8, Leac;->d:Landroid/content/res/Resources;

    move-object v0, p2

    iput-object v0, v8, Leac;->a:Lfdg;
...
.method protected final c()Lgvm;
    ...
    iget-object v1, p0, Leac;->d:Landroid/content/res/Resources;
    ...
    invoke-direct {v1, p0, v2}, Ldyq;-><init>(Leac;I)V
    ...
    invoke-virtual {v0, v3, v4}, Lgwb;->e(J)V
    ...
    .line 8
    invoke-virtual {v1, v2}, Lkok;->g(I)V
