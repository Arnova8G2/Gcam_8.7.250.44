...
# direct methods
.method public constructor <init>(Landroid/content/res/Resources;Ljava/util/concurrent/ScheduledExecutorService;Livv;Lfdg;[B[B[B[B)V
    .locals 9

    .line 1
    move-object v8, p0

    const-string v3, "brella_portrait_smarts_chip"
    ...
    iput-object v0, v8, Lgfe;->d:Landroid/content/res/Resources;

    move-object v0, p4

    iput-object v0, v8, Lgfe;->a:Lfdg;
...
.method protected final c()Lgvm;
    ...
    iget-object v1, p0, Lgfe;->d:Landroid/content/res/Resources;
    ...
    invoke-direct {v1, p0, v2}, Lgar;-><init>(Lgfe;I)V
